...
Büyük 1 veriler ile çalıştığımız için veri görselleştirme bizim için olmazsa olmazdır. Veri görselleştirme işlemi için de birçok farklı teknik ve kütüphane kullanılmaktadır.
